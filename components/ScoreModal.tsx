...
import { X, Fingerprint, ShieldAlert, CheckCircle, AlertTriangle } from 'lucide-react';
...
export const ScoreModal: React.FC<ScoreModalProps> = ({ scoreData, onClose, t }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[85vh] transition-all duration-300 ease-out transform ${
            isVisible && !isClosing 
      ...
      >
        ...
        {/* Content */}
        <div className="p-6 bg-slate-50 dark:bg-slate-900 overflow-y-auto">
