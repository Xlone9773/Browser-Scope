...
export const SensorModal: React.FC<SensorModalProps> = ({ onClose, t }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col transition-all duration-300 ease-out transform ${
            isVisible && !isClosing 
      ...
      >
        ...
        {/* Content */}
        <div className="p-6 bg-slate-50 dark:bg-slate-900 overflow-y-auto max-h-[75vh]">
