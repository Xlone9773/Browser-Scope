...
export const zhHK: Translation = {
  loading: "正在掃描系統能力...",
  title: "BrowserScope",
  subtitle: "全面檢測您的瀏覽器環境、硬件能力、網絡狀態及前沿 Web API 支援情況。",
  refresh: "重新整理",
  footer: "所有資料均在本地瀏覽器中檢測，不會上傳任何個人私隱資訊。",
  ...
  cameraTool: {
    ...
    close: "關閉",
    current_res: "目前輸出解像度",
    max_res: "硬件最大解像度 (WebRTC)",
    permission_denied: "相機權限已被拒絕",
    error_hardware: "相機已被佔用或硬件錯誤",
  ...
  base64Tool: {
    title: "Canvas Base64 數據",
    desc: "Canvas 指紋渲染結果的原始數據表示。",
    copy: "複製 Base64",
    close: "關閉"
  },
  ...
  aboutModal: {
    ...
    version: "目前版本",
    desc: "一個輕量級、注重私隱的瀏覽器能力檢測工具，可快速檢視硬件資訊、網絡狀態及 Web API 支援情況。",
    changelog: "更新日誌",
