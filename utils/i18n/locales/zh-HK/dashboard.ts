...
export const dashboard = {
  ...
  featureDescs: {
    ...
    devicePosture: "檢測折叠屏幕等裝置的狀態與折叠模式",
  }
,
  "extensionsModal": {
    "title": "瀏覽器擴充功能"
...
,
  ...
  "browserReport": {
    ...
    "dimensionDescs": {
      ...
      "computing": "多線程支援、WASM 執行速度與 CPU 核心並行能力",
    ...
    "expand": "展開",
    "historyTitle": "歷史記錄",
    "confirmClearHistory": "您確定要清空所有的質檢評估歷史記錄嗎？此操作無法撤銷。",
    "clearHistory": "清空全部歷史",
    "deleteCurrentReport": "刪除當前報告",
    "confirmDeleteCurrent": "您確定要刪除當前選中的質檢報告嗎？",
    "confirmActionTitle": "確認刪除",
    "confirmActionBtn": "確認刪除",
    "cancelBtn": "取消",
