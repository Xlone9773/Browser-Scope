...
export const dashboard = {
  ...
  notifications: {
    ...
    viewport_small: {
      title: "画面表示エリアが小さすぎます",
      message: "現在の画面表示エリアが小さすぎます。一部のレイアウト、グラフ、または設定パネルの表示に問題が発生したり、操作しづらくなる可能性があります。"
    }
  },
  ...
  labels: {
    ...
    geo_long: "経度",
    geo_acc: "精度",
    apparent_coordinates: "見かけの座標 (改ざん)",
    real_coordinates: "実際の座標 (バイパス済)",
    geo_tampering: "位置情報の改ざん",
    geo_tampered_desc: "Location Guardまたは他の改ざんユーザースクリプトを検出しました！",
    geo_secure_active: "改ざん防止サンドボックスが有効",
    perm_notif: "通知権限",
    perm_midi: "MIDIデバイス",
    perm_geo: "位置情報",
    perm_camera: "カメラ",
