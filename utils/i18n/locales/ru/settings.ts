...
export const settings = {
  settings: {
    ...
    general: {
        ...
        fontFix: {
            title: "Исправление рендеринга шрифтов",
            desc: "Включает GPU-ускорение сглаживания и активирует скрытую перерисовку при запуске для устранения размытости текста."
        },
        showTabs: {
