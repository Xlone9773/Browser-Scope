  ...
  settings: {
    ...
    general: {
        ...
        disableTabAnimations: {
            title: "Отключить анимацию переключения вкладок",
            desc: "Мгновенное переключение категорий на главной странице без анимации."
        },
        fastAnimations: {
    ...
    modules: {
        ...
        settingsTitle: "Настройки модулей",
        disableCache: "Отключить кеш",
        disableCacheDesc: "Уничтожать модули сразу после закрытия. Принудительно перезагружать при следующем открытии, экономя память, но требуя сеть.",
        disableLazyLoading: "Отключить ленивую загрузку",
        disableLazyLoadingDesc: "Кешировать все модули локально при запуске вместо загрузки по требованию.",
        alwaysShowLoading: "Всегда показывать индикатор",
        alwaysShowLoadingDesc: "Показывать индикатор загрузки независимо от статуса кеша для визуального единообразия.",
        lazyTabChange: "Задержка при переключении вкладок",
        lazyTabChangeDesc: "Показывать размытую маску загрузки со спиннером при смене вкладок настроек, блокируя клики для предотвращения случайных нажатий.",
