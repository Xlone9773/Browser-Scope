...
export const common = {
  ...
  search: {
    placeholder: "Поиск по категориям, картам или значениям...",
    scope: "Область поиска",
    scope_all: "Весь текст",
    scope_cards: "Только содержимое карт",
    match: "Режим соответствия",
    match_fuzzy: "Нечеткий поиск",
    match_exact: "Точное соответствие",
    settingsTooltip: "Дополнительные настройки поиска",
    no_results: "Соответствующие категории или карты не найдены."
  }
};
