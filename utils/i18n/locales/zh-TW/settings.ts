  ...
  settings: {
    ...
    developer: {
        config: {
            ...
            snippetToggleBlur: "切換背景模糊 (修復白螢幕遮擋)",
        ...
        console: {
            ...
            presets: {
                ...
                screenInfo: { label: "螢幕資訊", desc: "解析度與像素比例" },
                ...
                network: { label: "網路資訊", desc: "連線與頻寬情況" },
                memory: { label: "記憶體狀況", desc: "堆積記憶體大小 (僅 Chrome)" }
            }
        },
        floating_state: {
            title: "開發者工具處於懸浮窗模式",
    ...
    modules: {
        ...
        settingsTitle: "模組設定",
        disableCache: "禁用快取",
        disableCacheDesc: "用完即銷毀，每次打開都走一遍載入流程，絕不快取到本地，適合資源緊張的情況。",
        ...
        mutualLazyTag: "與禁用快取互斥",
        mutualCacheWarning: "💡 已啟用 '禁用懶加載'，本項已被自動關閉",
        mutualLazyWarning: "💡 已啟用 '禁用快取'，本項已被自動關閉",
        forceLoadingTag: "隨禁用快取聯動",
        forceLoadingWarning: "💡 已啟用 '禁用快取'，本項已被強制開啟",
        overlay: {
            cacheDisabled: "禁用快取已開啟",
            lazyLoadingDisabled: "禁用懶加載已開啟",
            managementUnavailable: "管理功能不可用，請在設定中關閉該選項後重試。",
            openSettings: "展開設定"
        }
    },
    versions: {
