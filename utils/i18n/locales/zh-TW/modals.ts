...
本軟件按“原樣”提供，不提供任何形式的明示或暗示保證，包括但不限於對適銷性、特定用途適用性和非侵權性的保證。在任何情況下，作者或版權持有人均不對因本軟件或本軟件的使用或其他交易而引起的、由本軟件引起的或與之相關的任何索賠、損害或其他責任（無論是合同訴訟、侵權訴訟還是其他訴訟）承擔責任。`
  ...
  storageBenchmark: {
    ...
    cleanup_btn: "清除殘留",
    cleanup_all: "清除所有殘留",
    cleanup_success: "測試殘留已成功清除。",
    cleanup_error: "部分儲存殘留清理失敗。",
    cleaning: "正在清理...",
    no_residues_found: "未檢測到殘留測試資料。",
    residues_detected: "檢測到測試殘留資料",
    storage_used: "已用儲存",
    cleanup_tooltip: "手動清除基準測試建立的臨時資料庫、快取項及 OPFS 臨時檔案"
  },
  heatmap: {
    title: "全球網絡品質監測",
    start: "快速掃描",
  ...
  "extensionsModal": {
    "title": "瀏覽器擴充功能檢測",
    "note_strong": "注意：",
    "note_text": "出於隱私與安全考量，瀏覽器並未向普通網頁開放枚舉全部已安裝擴充功能的原生 API。本工具基於多種啟發式深度特徵探測（如檢測全域 Hook 物件、特定 DOM 標記屬性、內建 API 介面及樣式表注入等）識別常見的擴充功能，並非您實際安裝的全部擴充清單。",
    ...
    "names": {
      ...
      "ghostery": "Ghostery (隱私追蹤攔截)",
      "privacy-badger": "Privacy Badger (隱私獾)",
      "duckduckgo": "DuckDuckGo 隱私保護",
    ...
    "descs": {
      ...
      "adguard": "多功能廣告封鎖與網頁隱私保護擴充功能",
      "ghostery": "視覺化追蹤器攔截與廣告清理工具",
      "privacy-badger": "電子前哨基金會 (EFF) 智慧行為分析防追蹤器",
      "duckduckgo": "DuckDuckGo 隱私保護、加密強制與無追蹤搜尋",
