...
export const dashboard = {
  ...
  labels: {
    ...
    geo_long: "Longitude",
    geo_acc: "Accuracy",
    apparent_coordinates: "Apparent (Spoofed)",
    real_coordinates: "Real (Bypassed)",
    geo_tampering: "Geolocation Spoofing",
    geo_tampered_desc: "Location Guard or other spoofing UserScript detected!",
    geo_secure_active: "Anti-Spoofing Shield Active",
  ...
  featureDescs: {
    ...
    webhid: "Access human interface devices",
    serial: "Communicate with serial ports",
    webotp: "One-Time Password receiver",
    cookieStore: "Service Worker cookie access",
    shapeDetection: "Detect faces or barcodes",
    virtualKeyboard: "Control virtual keyboard layout",
    keyboardMap: "Resolve physical key layouts",
    devicePosture: "Detect foldable device states",
  }
,
