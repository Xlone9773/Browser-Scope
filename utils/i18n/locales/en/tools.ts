...
export const tools = {
  ...
  poisoning: {
    ...
    media_persistent_mismatch: "❌ Persistent Device ID mismatch detected: Current deviceIds/order differ from the originally stored fingerprint in localStorage, indicating ID reset or randomization across refreshes (typically Brave/Cromite farbling).",
    ...
    media_persistent_saved: "💾 Saved active media devices fingerprint to localStorage for future session comparisons.",
    media_persistent_match: "✅ Current Media Device fingerprint matches originally stored localStorage baseline perfectly.",
    media_persistent_no_baseline: "💾 No prior baseline found in localStorage. Saved current media devices fingerprint for future session comparisons.",
