  ...
  const modalStates: ModuleState[] = [
    {
      ...
      setOpen: (v) => (v ? open("settings") : close("settings")),
      impact: "Low",
      isSystem: true,
      isLoaded: true,
    },
    {
      id: "camera",
      name: t.cameraTool.title,
      isOpen: visibility.camera,
      setOpen: (v) => (v ? open("camera") : close("camera")),
      impact: "High",
    ...
    {
      id: "audio",
      name: t.audioTool.title,
      isOpen: visibility.audio,
      setOpen: (v) => (v ? open("audio") : close("audio")),
      impact: "Medium",
    ...
    {
      id: "webgl",
      name: t.webglTool.title,
      isOpen: visibility.webgl,
      setOpen: (v) => (v ? open("webgl") : close("webgl")),
      impact: "Low",
    ...
    },
    {
      ...
      setOpen: (v) => (v ? open("canvas") : close("canvas")),
      impact: "Low",
    ...
    {
      id: "base64",
      name: t.base64Tool.title,
      isOpen: visibility.base64,
      setOpen: (v) => (v ? open("base64") : close("base64")),
      impact: "Low",
    ...
    {
      id: "about",
      name: t.aboutModal.title,
      isOpen: visibility.about,
      setOpen: (v) => (v ? open("about") : close("about")),
      impact: "Low",
    ...
    {
      id: "sensor",
      name: t.sensorModal.sensor_title,
      isOpen: visibility.sensor,
      setOpen: (v) => (v ? open("sensor") : close("sensor")),
      impact: "Medium",
    ...
    {
      id: "score",
      name: t.scoreModal.score_details_title,
      isOpen: visibility.score,
      setOpen: (v) => (v ? open("score") : close("score")),
      impact: "Low",
    ...
    {
      id: "fingerprint",
      name: t.fingerprintModal.title,
      isOpen: visibility.fingerprint,
      setOpen: (v) => (v ? open("fingerprint") : close("fingerprint")),
      impact: "Medium",
    ...
    {
      id: "benchmark",
      name: t.benchmarkModal.title,
      isOpen: visibility.benchmark,
      setOpen: (v) => (v ? open("benchmark") : close("benchmark")),
      impact: "High",
    ...
    {
      id: "tools",
      name: t.hardwareToolsModal.title,
      isOpen: visibility.tools,
      setOpen: (v) => (v ? open("tools") : close("tools")),
      impact: "Medium",
    ...
    {
      id: "ai",
      name: t.aiPlayground.title,
      isOpen: visibility.ai,
      setOpen: (v) => (v ? open("ai") : close("ai")),
      impact: "High",
      onUnload: () => unload("ai"),
    ...
    {
      id: "gamepad",
      name: t.gamepadTool.title,
      isOpen: visibility.gamepad,
      setOpen: (v) => (v ? open("gamepad") : close("gamepad")),
      impact: "Medium",
    ...
    {
      id: "webDevice",
      name: t.webDevice.title,
      isOpen: visibility.webDevice,
      setOpen: (v) => (v ? open("webDevice") : close("webDevice")),
      impact: "Medium",
    ...
    {
      id: "vision",
      name: t.visionModal.title,
      isOpen: visibility.vision,
      setOpen: (v) => (v ? open("vision") : close("vision")),
      impact: "High",
    ...
    {
      id: "speed",
      name: t.speedTest.title,
      isOpen: visibility.speed,
      setOpen: (v) => (v ? open("speed") : close("speed")),
      impact: "Medium",
    ...
    {
      id: "compute",
      name: t.computeStress.title,
      isOpen: visibility.compute,
      setOpen: (v) => (v ? open("compute") : close("compute")),
      impact: "High",
    ...
    {
      id: "video",
      name: t.actions.open_video_test,
      isOpen: visibility.video,
      setOpen: (v) => (v ? open("video") : close("video")),
      impact: "High",
    ...
    {
      id: "graphics",
      name: t.graphicsModal.title,
      isOpen: visibility.graphics,
      setOpen: (v) => (v ? open("graphics") : close("graphics")),
      impact: "Medium",
    ...
    {
      id: "speech",
      name: t.speechModal.title,
      isOpen: visibility.speech,
      setOpen: (v) => (v ? open("speech") : close("speech")),
      impact: "Medium",
    ...
    {
      id: "midi",
      name: t.midiModal.title,
      isOpen: visibility.midi,
      setOpen: (v) => (v ? open("midi") : close("midi")),
      impact: "Low",
    ...
    {
      id: "storageBench",
      name: t.storageBenchmark.title,
      isOpen: visibility.storageBench,
      setOpen: (v) => (v ? open("storageBench") : close("storageBench")),
      impact: "High",
    ...
    },
    {
      ...
      setOpen: (v) => (v ? open("heatmap") : close("heatmap")),
      impact: "Medium",
    ...
    {
      id: "rayTracing",
      name: t.rayTracing.title,
      isOpen: visibility.rayTracing,
      setOpen: (v) => (v ? open("rayTracing") : close("rayTracing")),
      impact: "High",
    ...
    },
    {
      ...
      setOpen: (v) => (v ? open("extensions") : close("extensions")),
      impact: "Low",
    ...
    {
      id: "networkTools",
      name: t.settings.nav.network,
      isOpen: visibility.networkTools,
      setOpen: (v) => (v ? open("networkTools") : close("networkTools")),
      impact: "Medium",
    ...
    {
      id: "displayTools",
      name: t.settings.nav.display,
      isOpen: visibility.displayTools,
      setOpen: (v) => (v ? open("displayTools") : close("displayTools")),
      impact: "Low",
